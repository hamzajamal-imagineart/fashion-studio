...
export function SiteNav() {
  ...
  // Light nav in both states — at top it sits over the dark hero video/overlay,
  // and scrolled it's the dark glass pill. Both are dark backgrounds.
      ...
      >
        <div
          ...
          style={{
            ...
            padding:        scrolled ? "8px 12px" : "10px clamp(20px,3vw,40px)",
            borderRadius:   "22px",
