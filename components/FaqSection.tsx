      ...
      <div className="container-page">
        <div className="py-16 md:py-24 flex flex-col lg:flex-row gap-10 lg:gap-20">
          ...
          <Reveal className="lg:w-[360px] shrink-0">
            ...
            <h2
              className="font-display font-semibold leading-[1.05] tracking-[-0.5px] mt-4 mb-0 text-content-primary"
              style={{ fontSize: "clamp(36px, 4vw, 52px)" }}
            >
              Not AI-gen answers.{" "}
              <span className="text-black/35">Real ones here.</span>
            </h2>
            <p className="font-sans text-[17px] leading-[1.7] text-content-secondary max-w-[36ch] mt-5 tracking-[-0.005em]">
              Everything you need to know about generating on-brand product visuals.
            </p>
          </Reveal>
